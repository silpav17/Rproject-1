...
edx_updated <- edx  %>% mutate(n_year=format(as.POSIXct(timestamp,origin="1970-01-01"),"%Y")) %>% 
  mutate(n_month=format(as.POSIXct(timestamp,origin="1970-01-01"),"%m")) %>% 
  mutate(n_day=format(as.POSIXct(timestamp,origin="1970-01-01"),"%d")) %>% 
  mutate(n_hour=format(as.POSIXct(timestamp,origin="1970-01-01"),"%H")) %>% 
