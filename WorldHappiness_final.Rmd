...
Good job exploring an interesting dataset. I think some improvements that could have been made in the exploration of the dataset would have been to more clearly label the axes and title the plots, as well as perhaps computing the correlation between the two variables you plot. You comment on whether there appears to be a trend visually, but it would be interesting to see how this is either in agreement or disagreement with the quantitative outputs you may find.


Code was generally well done, but I think could have improved. One notable problem was in reading in the data, I used your github repository and the code tried to read in the data through a folder, Data_files, that does not exist in your repo. Be sure to check these details so that the code can run for all users. Good job exploring and visualizing the data in your dataset to gain an understanding of trends before performing the analysis.

I would have liked to see more detail throughout the report, especially in taking your analysis a step further. You looked at the performance of clustering algorithms, but there was not much in terms of interpreting their results in context. Further, in outputs such as your silhouette plot, you did not provide a discussion/interpretation. Notably, you found that some observations in cluster 2 yield negative values, which could have been interesting to discuss. It would have also been interesting to visualize the clusters in the data and discuss what patterns you observe / what seems to define the clusters.
